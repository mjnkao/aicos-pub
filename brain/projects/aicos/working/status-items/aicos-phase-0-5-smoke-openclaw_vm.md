# Status Item: AICOS-PHASE-0-5-SMOKE-OPENCLAW_VM
...
Item id: `AICOS-PHASE-0-5-SMOKE-OPENCLAW_VM`
Title: Phase 0.5 HTTP MCP smoke for openclaw-vm
Last write id: `20260428T050149Z-7a7c9a5ec7`
Last updated at: `2026-04-28T05:01:49+00:00`

## Actor Identity

Actor role: `A1`
Agent family: `openclaw-vm`
Agent instance id: `phase-0-5-openclaw-vm`
...
Execution context: `openclaw-vm`
Legacy actor family: `openclaw-vm`
Legacy logical role: `A1`
Work context: ``

## Summary

HTTP MCP token path for openclaw-vm can call tools/list, read startup bundle, and perform semantic status-item write during Phase 0.5 stabilization smoke.
